...
# Display exponentiated coefficients of the logistic regression model
...
# Display exponentiated confidence intervals of the logistic regression model coefficients
